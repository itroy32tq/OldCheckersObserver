...
namespace Checkers
{
    public static class Extensions
    {
        ...
        public static string ToSerializable(this string value, RecordType recordType, string destination = "")
        {
            var playerSide = GameManager.Self.Turn == ColorType.Black ? "1" : "2";
